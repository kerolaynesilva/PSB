...
Filename <- paste(strpath, "G2 DU-DR.txt", sep = "")
...
djp3_G1.X <- janelamento(df3$X.G1.X.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_G1.X,"X.G1.X.")))

dp3g1_X <- param_est_sinal(djp3_G1.X)

dp3g1R_x <- param_est_ruido(djp3_G1.X)

dfp3_g1x <- tabela_final(dp3g1_X,dp3g1R_x)

write.xlsx(dfp3_g1x, "tabelafinal_p3g1x.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p3g1x <- SNR(dp3g1_X,dp3g1R_x)



######### PARA G1.Y    ##########

djp3_G1.Y <- janelamento(df3$X.G1.Y.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_G1.Y,"X.G1.Y.")))

dp3g1_Y <- param_est_sinal(djp3_G1.Y)

dp3g1R_Y <- param_est_ruido(djp3_G1.Y)

dfp3_g1y <- tabela_final(dp3g1_Y,dp3g1R_Y)

write.xlsx(dfp3_g1y, "tabelafinal_p3g1y.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p3g1y <- SNR(dp3g1_Y,dp3g1R_Y)
...
djp3_G1.Z <- janelamento(df3$X.G1.Z.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_G1.Z,"X.G1.Z.")))

dp3g1_Z <- param_est_sinal(djp3_G1.Z)

dp3g1R_Z <- param_est_ruido(djp3_G1.Z)

dfp1_g1z <- tabela_final(dp3g1_X,dp3g1R_x)

write.xlsx(dfp3_g1z, "tabelafinal_p3g1z.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p3g1z <- SNR(dp3g1_Z,dp3g1R_Z)
...
djp3_A1.X <- janelamento(df3$X.A1.X.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_A1.X,"X.A1.X.")))

dp3a1_X <- param_est_sinal(djp3_A1.X)

dp3a1R_x <- param_est_ruido(djp3_A1.X)

dfp3_a1x <- tabela_final(dp3a1_X,dp3a1R_x)

write.xlsx(dfp1_a1x, "tabelafinal_p3a1x.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p3a1x <- SNR(dp3a1_X,dp3a1R_x)


######### PARA A1.Y    ##########

djp3_A1.Y <- janelamento(df3$X.A1.Y.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_A1.Y,"X.A1.Y.")))

dp3a1_Y <- param_est_sinal(djp3_A1.Y)

dp3a1R_Y <- param_est_ruido(djp3_A1.Y)

dfp3_a1y <- tabela_final(dp3a1_Y,dp3a1R_Y)

write.xlsx(dfp3_A1y, "tabelafinal_p3a1y.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1a1y <- SNR(dp3a1_Y,dp3a1R_Y)


######### PARA A1.Z    ##########

djp3_A1.Z <- janelamento(df3$X.A1.Z.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_A1.Z,"X.A1.Z.")))

dp3a1_Z <- param_est_sinal(djp3_A1.Z)

dp3a1R_Z <- param_est_ruido(djp3_A1.Z)

dfp3_a1z <- tabela_final(dp3a1_X,dp3a1R_x)

write.xlsx(dfp3_a1z, "tabelafinal_p3a1z.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p3a1z <- SNR(dp3a1_Z,dp3a1R_Z)
...
djp3_M1.X <- janelamento(df3$X.M1.X.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_M1.X,"X.M1.X.")))

dp3m1_X <- param_est_sinal(djp3_M1.X)

dp3m1R_x <- param_est_ruido(djp3_M1.X)

dfp3_m1x <- tabela_final(dp3m1_X,dp3m1R_x)

write.xlsx(dfp2_m1x, "tabelafinal_p1m1x.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p3m1x <- SNR(dp3m1_X,dp3m1R_x)


######### PARA M1.Y    ##########

djp3_M1.Y <- janelamento(df3$X.M1.Y.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_M1.Y,"X.M1.Y.")))

dp3m1_Y <- param_est_sinal(djp3_M1.Y)

dp3m1R_Y <- param_est_ruido(djp3_M1.Y)

dfp3_m1y <- tabela_final(dp3m1_Y,dp3m1R_Y)

write.xlsx(dfp3_m1y, "tabelafinal_p3m1y.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p3m1y <- SNR(dp3m1_Y,dp3m1R_Y)


######### PARA M1.Z    ##########

djp3_M1.Z <- janelamento(df3$X.M1.Z.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp3_M1.Z,"X.M1.Z.")))

dp3m1_Z <- param_est_sinal(djp3_M1.Z)

dp3m1R_Z <- param_est_ruido(djp3_M1.Z)

dfp3_m1z <- tabela_final(dp3m1_X,dp3m1R_x)

write.xlsx(dfp3_m1z, "tabelafinal_p3m1z.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p3m1z <- SNR(dp3m1_Z,dp3m1R_Z)



## Plotar gráfico para analisar a reprodutibilidade ##

qplot(dp3g1_X$time, dp3g1_X$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_G1.X

qplot(dp3g1R_x$time, dp3g1R_x$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_G1.X

qplot(dp3g1_Y$time, dp3g1_Y$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_G1.Y

qplot(dp3g1R_Y$time, dp3g1R_Y$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_G1.Y

qplot(dp3g1_Z$time, dp3g1_Z$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_G1.Z

qplot(dp3g1R_Z$time, dp3g1R_Z$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_G1.Z


qplot(dp3a1_X$time, dp3a1_X$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_A1.X

qplot(dp3a1R_x$time, dp3a1R_x$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_A1.X

qplot(dp3g1_Y$time, dp3a1_Y$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_A1.Y

qplot(dp3a1R_Y$time, dp3a1R_Y$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_A1.Y

qplot(dp3a1_Z$time, dp3a1_Z$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_A1.Z

qplot(dp3a1R_Z$time, dp3a1R_Z$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_A1.Z


qplot(dp3m1_X$time, dp3m1_X$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_M1.X

qplot(dp3m1R_x$time, dp3m1R_x$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_M1.X

qplot(dp3m1_Y$time, dp3m1_Y$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_M1.Y

qplot(dp3m1R_Y$time, dp3m1R_Y$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_M1.Y

qplot(dp3m1_Z$time, dp3m1_Z$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P3_M1.Z

qplot(dp3m1R_Z$time, dp3m1R_Z$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P3_M1.Z
