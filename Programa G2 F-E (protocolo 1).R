...
Filename <- paste(strpath, "G2 F-E.txt", sep = "")
...
djp1_G1.X <- janelamento(df3$X.G1.X.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_G1.X,"X.G1.X.")))

dp1g1_X <- param_est_sinal(djp1_G1.X)

dp1g1R_x <- param_est_ruido(djp1_G1.X)

dfp1_g1x <- tabela_final(dp1g1_X,dp1g1R_x)

write.xlsx(dfp1_g1x, "tabelafinal_p1g1x.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1g1x <- SNR(dp1g1_X,dp1g1R_x)



######### PARA G1.Y    ##########

djp1_G1.Y <- janelamento(df3$X.G1.Y.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_G1.Y,"X.G1.Y.")))

dp1g1_Y <- param_est_sinal(djp1_G1.Y)

dp1g1R_Y <- param_est_ruido(djp1_G1.Y)

dfp1_g1y <- tabela_final(dp1g1_Y,dp1g1R_Y)

write.xlsx(dfp1_g1y, "tabelafinal_p1g1y.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1g1y <- SNR(dp1g1_Y,dp1g1R_Y)
...
djp1_G1.Z <- janelamento(df3$X.G1.Z.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_G1.Z,"X.G1.Z.")))

dp1g1_Z <- param_est_sinal(djp1_G1.Z)

dp1g1R_Z <- param_est_ruido(djp1_G1.Z)

dfp1_g1z <- tabela_final(dp1g1_X,dp1g1R_x)

write.xlsx(dfp1_g1z, "tabelafinal_p1g1z.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1g1z <- SNR(dp1g1_Z,dp1g1R_Z)
...
djp1_A1.X <- janelamento(df3$X.A1.X.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_A1.X,"X.A1.X.")))

dp1a1_X <- param_est_sinal(djp1_A1.X)

dp1a1R_x <- param_est_ruido(djp1_A1.X)

dfp1_a1x <- tabela_final(dp1a1_X,dp1a1R_x)

write.xlsx(dfp1_a1x, "tabelafinal_p1a1x.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1a1x <- SNR(dp1a1_X,dp1a1R_x)


######### PARA A1.Y    ##########

djp1_A1.Y <- janelamento(df3$X.A1.Y.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_A1.Y,"X.A1.Y.")))

dp1a1_Y <- param_est_sinal(djp1_A1.Y)

dp1a1R_Y <- param_est_ruido(djp1_A1.Y)

dfp1_a1y <- tabela_final(dp1a1_Y,dp1a1R_Y)

write.xlsx(dfp1_A1y, "tabelafinal_p1a1y.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1a1y <- SNR(dp1a1_Y,dp1a1R_Y)


######### PARA A1.Z    ##########

djp1_A1.Z <- janelamento(df3$X.A1.Z.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_A1.Z,"X.A1.Z.")))

dp1a1_Z <- param_est_sinal(djp1_A1.Z)

dp1a1R_Z <- param_est_ruido(djp1_A1.Z)

dfp1_a1z <- tabela_final(dp1a1_X,dp2a1R_x)

write.xlsx(dfp1_a1z, "tabelafinal_p1a1z.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1a1z <- SNR(dp1a1_Z,dp1a1R_Z)
...
djp1_M1.X <- janelamento(df3$X.M1.X.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_M1.X,"X.M1.X.")))

dp1m1_X <- param_est_sinal(djp1_M1.X)

dp1m1R_x <- param_est_ruido(djp1_M1.X)

dfp1_m1x <- tabela_final(dp1m1_X,dp1m1R_x)

write.xlsx(dfp2_m1x, "tabelafinal_p1m1x.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1m1x <- SNR(dp1m1_X,dp1m1R_x)


######### PARA M1.Y    ##########

djp1_M1.Y <- janelamento(df3$X.M1.Y.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_M1.Y,"X.M1.Y.")))

dp1m1_Y <- param_est_sinal(djp1_M1.Y)

dp1m1R_Y <- param_est_ruido(djp1_M1.Y)

dfp1_m1y <- tabela_final(dp1m1_Y,dp1m1R_Y)

write.xlsx(dfp1_m1y, "tabelafinal_p1m1y.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1m1y <- SNR(dp1m1_Y,dp1m1R_Y)


######### PARA M1.Z    ##########

djp1_M1.Z <- janelamento(df3$X.M1.Z.,40)

htmltools::browsable(htmltools::tagList(plotar_janela(djp1_M1.Z,"X.M1.Z.")))

dp1m1_Z <- param_est_sinal(djp1_M1.Z)

dp1m1R_Z <- param_est_ruido(djp1_M1.Z)

dfp1_m1z <- tabela_final(dp1m1_X,dp1m1R_x)

write.xlsx(dfp1_m1z, "tabelafinal_p1m1z.xlsx", colNames = TRUE)

## Relação sinal/ruído 

sinal_ruido_p1m1z <- SNR(dp1m1_Z,dp1m1R_Z)



## Plotar gráfico para analisar a reprodutibilidade ##

qplot(dp1g1_X$time, dp1g1_X$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_G1.X

qplot(dp1g1R_x$time, dp1g1R_x$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_G1.X

qplot(dp1g1_y$time, dp1g1_y$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_G1.Y

qplot(dp1g1_y$time, dp1g1_y$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_G1.Y

qplot(dp1g1_Z$time, dp1g1_Z$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_G1.Z

qplot(dp1g1R_Z$time, dp1g1R_Z$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_G1.Z


qplot(dp1a1_X$time, dp1a1_X$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_A1.X

qplot(dp1a1R_x$time, dp1a1R_x$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_A1.X

qplot(dp1g1_Y$time, dp1a1_Y$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_A1.Y

qplot(dp1a1R_Y$time, dp1a1R_Y$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_A1.Y

qplot(dp1a1_Z$time, dp1a1_Z$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_A1.Z

qplot(dp1a1R_Z$time, dp1a1R_Z$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_A1.Z


qplot(dp1m1_X$time, dp1m1_X$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_M1.X

qplot(dp1m1R_x$time, dp1m1R_x$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_M1.X

qplot(dp1m1_Y$time, dp1m1_Y$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_M1.Y

qplot(dp1m1R_Y$time, dp1m1R_Y$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_M1.Y

qplot(dp1m1_Z$time, dp1m1_Z$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P1_M1.Z

qplot(dp1m1R_Z$time, dp1m1R_Z$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P1_M1.Z
