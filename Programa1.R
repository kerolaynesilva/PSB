...
dg1R_y <- param_est_ruido(djanela)
...
sinal_ruido_p2g1y <- SNR(dg1_y,dg1R_y)
...
dfp2_g1y <- tabela_final(dg1_y,dg1R_y)

write.xlsx(dfp2_g1y, "tabelafinal_g1y.xlsx", colNames = TRUE)
...
qplot(dg1_y$time, dg1_y$variancia, geom=c("point", "line"))  #Gráfico da variância do sinal P2_G1.Y

qplot(dg1_y$time, dg1_y$variancia, geom=c("point", "line"))  # Gráfico da variância do ruído P2_G1.Y
